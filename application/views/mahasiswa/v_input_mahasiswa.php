...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		...
		<?php echo form_open_multipart('mahasiswa/input_mahasiswa') ?>
		...
		<div class="form-group">
			...
			<input id="nama_mahasiswa" name="nama_mahasiswa" type="text" class="form-control" placeholder="Nama Mahasiswa">
		</div>
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="form-group">
					<label>Foto</label>
					<input id="preview_gambar" name="foto" type="file" class="form-control" accept="image/*" required>
				</div>
			</div>
			<div class="col-sm-8">
				<div class="form-group">
					<label>Preview Foto</label><br>
					<img src="" alt="" id="gambar_load" width="250px">
				</div>
			</div>
		</div>
